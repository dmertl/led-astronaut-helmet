...
void draw() {
  switch (current_mode) {
    ...
    case 2: strip.RainbowCycle(5, 2);
      break;
    case 3: strip.TheaterChase(strip.Color(85, 0, 0), strip.Color(0, 0, 0), 80);
      break;
    case 4: strip.TheaterChase(strip.Color(85, 0, 0), strip.Color(0, 0, 0), 40);
      break;
    case 5: strip.Scanner(strip.Color(85, 85, 85), 100);
      break;
    case 6: strip.Scanner(strip.Color(85, 85, 85), 50);
      break;
    case 7: strip.Scanner(strip.Color(85, 85, 85), 20);
      break;
